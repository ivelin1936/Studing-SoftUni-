    ...
    public void register() throws IOException {
        ...
        if (this.validator.isValid(serviceModel)) {
            ...
            FacesContext.getCurrentInstance()
                    .addMessage(null, new FacesMessage("Incorrect data! Please try again."));
