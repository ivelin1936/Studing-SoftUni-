package p02_createClasses.http.impl;

import p02_createClasses.http.interfaces.HttpCookie;
...
public class HttpRequestImpl implements HttpRequest {
    ...
    private String parseRequestHeaders(String[] remainLines) {
        ...
        for (int i = 0; i < remainLines.length; i++) {
            ...
            if (headerName.equalsIgnoreCase(Const.COOKIE)) {
    ...
    private void parseCookies(String headerValue) {
        String cookies = headerValue.trim();
